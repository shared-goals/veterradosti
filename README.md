...
![Создать свой Текст просто](https://text.sharedgoals.ru/img/github_fork.gif)
...
![Включить публикацию для проекта](https://text.sharedgoals.ru/img/github_publish.gif)
...
![Разрешить исполнение Actions](https://text.sharedgoals.ru/img/github_actions.gif)
...
Например, изменить первую страницу Приветствия в файле text/index.md.

После изменения автоматически запускается Action, который:

- [Скачает из облака и развернёт образ открытой операционной системы Linux Ubuntu](https://text.sharedgoals.ru/p2-170-opensource.md#saas),
- Установит на неё [открытое программное обеспечение MkDocs, Pandoc](https://text.sharedgoals.ru/p2-200-text#mkdocs),
...
![Автоматический процесс сборки Текста](https://text.sharedgoals.ru/img/github_build.gif)
